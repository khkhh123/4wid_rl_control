...
def run_learning(env):
    ...
    model_path = f"carmaker_sac_4wid_{profile}.zip"
    best_model_path = f"carmaker_sac_4wid_{profile}_best.zip"
    interrupt_model_path = f"carmaker_sac_4wid_{profile}_interrupt.zip"
