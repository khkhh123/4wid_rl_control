...
# [1] 보상 함수 파라미터  ◀  자주 수정
# ─────────────────────────────────────────────────────────────────────────────
YAW_RATE_WEIGHT          = float(os.getenv("YAW_RATE_WEIGHT",          "1"))
...
ENERGY_LOSS_WEIGHT       = float(os.getenv("ENERGY_LOSS_WEIGHT",       "1e-0"))
...
_MODEL_BASENAME = os.getenv("MODEL_BASENAME", "carmaker_sac_4wid_dyc_C").strip()
